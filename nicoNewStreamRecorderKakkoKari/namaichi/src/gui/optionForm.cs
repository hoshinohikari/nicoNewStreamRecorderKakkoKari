...
public partial class optionForm : Form
{
    ...
    private void hozonFolderSanshouBtn_Click(object sender, EventArgs e)
    {
    ...
    private void fileNameOptionBtn(object sender, EventArgs e)
    {
    }

    private void FileNameDokujiSetteiBtn_Click(object sender, EventArgs e)
    {
    ...
    private void optionOk_Click(object sender, EventArgs e)
    {
        ...
        if (importer2 != null && importer2.SourceInfo != null)
        {
            ...
            if (isCookieFileSiteiChkBox2.Checked)
                SourceInfoSerialize.save(si2.GenerateCopy(si2.BrowserName, si2.ProfileName, cookieFileText2.Text),
                    true);
...
//				{"IsDefaultEngine",isDefaultEngineChkBox.Checked.ToString().ToLower()},
    ...
    private async void Selector_PropertyChanged(object sender, PropertyChangedEventArgs e)
    {
...
//                        txtUserSession.Enabled = result.Status == CookieImportState.Success;
    ...
    private async void Selector2_PropertyChanged(object sender, PropertyChangedEventArgs e)
    {
        //if (isInitRun) initRec();
...
//			a.GetCookieImporter(new CookieSourceInfo("
    ...
    private void btnOpenCookieFileDialog_Click(object sender, EventArgs e)
    {
...
//        	cfg.set("isAllBrowserMode", nicoSessionComboBox1.Selector.IsAllBrowserMode.ToString());
    ...
    private void btnOpenCookieFileDialog2_Click(object sender, EventArgs e)
    {
        var tsk = nicoSessionComboBox2.ShowCookieDialogAsync();
    }

    private void checkBoxShowAll2_CheckedChanged(object sender, EventArgs e)
    {
        nicoSessionComboBox2.Selector.IsAllBrowserMode = checkBoxShowAll2.Checked;
//        	cfg.set("isAllBrowserMode", nicoSessionComboBox1.Selector.IsAllBrowserMode.ToString());
    }

    private int getSubFolderNameType()
    {
...
//        	isLimitPopupChkBox.Checked = bool.Parse(cfg.get("Islimitpopup"));
        ...
        reserveMessageList.Text =
            string.IsNullOrEmpty(cfg.get("reserveMessage")) ? "ダイアログで確認" : cfg.get("reserveMessage");
...
//			!bool.Parse(cfg.get("defaultBrowserPath"))
    ...
    private void cookieFileSiteiSanshouBtn_Click(object sender, EventArgs e)
    {
    ...
    private void cookieFileSiteiSanshouBtn2_Click(object sender, EventArgs e)
    {
        var dialog = new OpenFileDialog();
        dialog.Multiselect = false;
        var result = dialog.ShowDialog();
    ...
    private void isCookieFileSiteiChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isCookieFileSiteiChkBox_UpdateAction();
    }

    private void isCookieFileSiteiChkBox2_CheckedChanged(object sender, EventArgs e)
    {
        isCookieFileSiteiChkBox2_UpdateAction();
    }

    private void isCookieFileSiteiChkBox_UpdateAction()
    {
//			cookieFileText.Enabled = isCookieFileSiteiChkBox.Checked;
//			cookieFileSanshouBtn.Enabled = isCookieFileSiteiChkBox.Checked;
    }

    private void isCookieFileSiteiChkBox2_UpdateAction()
    {
//			cookieFileText.Enabled = isCookieFileSiteiChkBox.Checked;
//			cookieFileSanshouBtn.Enabled = isCookieFileSiteiChkBox.Checked;
    }

    private void useDefaultRecFolderChkBox_CheckedChanged(object sender, EventArgs e)
    {
        useDefaultRecFolderChkBox_UpdateAction();
    }

    private void useDefaultRecFolderChkBox_UpdateAction()
    {
        recordDirectoryText.Enabled = !useDefaultRecFolderChk.Checked;
        recFolderSanshouBtn.Enabled = !useDefaultRecFolderChk.Checked;
    }

    private void useSubFolderChk_CheckedChanged(object sender, EventArgs e)
    {
        useSubFolderChk_UpdateAction();
    }

    private void useSubFolderChk_UpdateAction()
    {
        /*
    ...
    private async void loginBtn2_Click(object sender, EventArgs e)
    {
        var cg = new CookieGetter(cfg);
    ...
    private void isDefaultBrowserPathChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isDefaultBrowserPathChkBox_UpdateAction();
    }

    private void isDefaultBrowserPathChkBox_UpdateAction()
    {
    ...
    private void browserPathSanshouBtn_Click(object sender, EventArgs e)
    {
        var dialog = new OpenFileDialog();
        dialog.Multiselect = false;
        var result = dialog.ShowDialog();
    ...
    private void isGetCommentChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isGetCommentChkBox_UpdateAction();
    }

    private void isGetCommentChkBox_UpdateAction()
    {
    ...
    private void highRankBtn_Click(object sender, EventArgs e)
    {
        var ranks = new List<int> { 7, 6, 8, 0, 1, 2, 3, 4, 5, 9 };
    ...
    private void lowRankBtn_Click(object sender, EventArgs e)
    {
        var ranks = new List<int> { 9, 5, 4, 3, 2, 1, 0, 8, 6, 7 };
        for (var i = ranks.Count; i < config.Config.qualityList.Count; i++)
            ranks.Add(i);
        qualityListBox.Items.Clear();
        qualityListBox.Items.AddRange(getRanksToItems(ranks.ToArray(), qualityListBox));
...
//			var ret = new ListBox.ObjectCollection(owner);
    ...
    private List<int> getItemsToRanks(ListBox.ObjectCollection items)
    {
    ...
    private void setInitQualityRankList(string qualityRank)
    {
...
//			ranks.AddRange(qualityRank.Split(','));
    ...
    private string getSegmentSaveType()
    {
        if (isSegmentRenketuRadioBtn.Checked) return "0";
        if (isSegmentNotRenketuRadioBtn.Checked) return "1";
        //			else if (isSegmentBothRadioBtn.Checked) return "2";
        return "0";
    }

    private void setSegmentSaveType(string segmentSaveType)
    {
...
//			else if (segmentSaveType == "2") isSegmentBothRadioBtn.Checked = true;
    ...
    private void isSegmentNotRenketuRadioBtn_CheckedChanged(object sender, EventArgs e)
    {
        isRenketuAfterChkBox_UpdateAction();
    }

    private void isRenketuAfterChkBox_UpdateAction()
    {
        isRenketuAfterChkBox.Enabled = isSegmentNotRenketuRadioBtn.Checked;
    }

    private void isDefaultEngineChkBox_UpdateAction()
    {
    ...
    private void setEngineType(string EngineMode)
    {
    ...
    private void isDefaultEngineChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isDefaultEngineChkBox_UpdateAction();
    }
    ...
    private void setCommentViewerType()
    {
    ...
    private void isDefaultPlayerRadioBtn_UpdateAction()
    {
    ...
    private void isDefaultCommentViewerRadioBtn_UpdateAction()
    {
    ...
    private void isDefaultPlayerRadioBtn_CheckedChanged(object sender, EventArgs e)
    {
        isDefaultPlayerRadioBtn_UpdateAction();
    }

    private void isDefaultCommentViewerRadioBtn_CheckedChanged(object sender, EventArgs e)
    {
        isDefaultCommentViewerRadioBtn_UpdateAction();
    }

    private void isHosoInfoChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isDescriptionChkBox_UpdateAction();
    }

    private void isDescriptionChkBox_UpdateAction()
    {
        isDescriptionTagChkBox.Enabled = isHosoInfoChkBox.Checked;
    }

    private void anotherPlayerSanshouBtn_Click(object sender, EventArgs e)
    {
        var dialog = new OpenFileDialog();
        dialog.Multiselect = false;
        var result = dialog.ShowDialog();
    ...
    private void anotherCommentViewerSanshouBtn_Click(object sender, EventArgs e)
    {
        var dialog = new OpenFileDialog();
        dialog.Multiselect = false;
        var result = dialog.ShowDialog();
    ...
    private void isSubHokanChkBox_CheckedChanged(object sender, EventArgs e)
    {
        isSubHokanChkBox_updateAction();
    }

    private void isSubHokanChkBox_updateAction()
    {
    ...
    private void IsUsePlayerChkBoxCheckedChanged(object sender, EventArgs e)
    {
        isUsePlayerChkBox_UpdateAction();
    }

    private void IsUseCommentViewerChkBoxCheckedChanged(object sender, EventArgs e)
    {
        isUseCommentViewerChkBox_UpdateAction();
    }

    private void isUsePlayerChkBox_UpdateAction()
    {
    ...
    private void isUseCommentViewerChkBox_UpdateAction()
    {
    ...
    private void IsSoundEndChkBoxCheckedChanged(object sender, EventArgs e)
    {
        updateIsSoundEndChkBox();
    }

    private void updateIsSoundEndChkBox()
    {
    ...
    private void IsDefaultSoundChkBtnCheckedChanged(object sender, EventArgs e)
    {
        updateIsSoundEndChkBox();
    }

    private void SoundSanshouBtnClick(object sender, EventArgs e)
    {
        ...
        f.Multiselect = false;
        var a = f.ShowDialog();
        if (a == DialogResult.OK) soundPathText.Text = f.FileName;
    }

    private void RtmpPathSanshouBtnClick(object sender, EventArgs e)
    {
        var f = new OpenFileDialog();
        f.DefaultExt = ".exe";
        ...
        f.Multiselect = false;
        var a = f.ShowDialog();
        if (a == DialogResult.OK) rtmpPathText.Text = f.FileName;
    }
    ...
    private void isChaseRecordRadioBtn_UpdateAction()
    {
    ...
    private void IsChaseRecordRadioBtnCheckedChanged(object sender, EventArgs e)
    {
        isChaseRecordRadioBtn_UpdateAction();
    }
    ...
    private void setBackColor(Color color)
    {
        ...
        foreach (var _c in c)
            if ( //_c.GetType() == typeof(GroupBox) ||
                _c.GetType() == typeof(Panel) ||
                _c.GetType() == typeof(Form)
    ...
    private void UseProxyChkBox_CheckedChanged(object sender, EventArgs e)
    {
        useProxyUpdate();
    }

    private void useProxyUpdate()
    {
    ...
    private void IsCommentConvertSpaceChkboxCheckedChanged(object sender, EventArgs e)
    {
        commentConvertStrText.Enabled = isCommentConvertSpaceChkbox.Checked;
    }

    private void commentReplaceTextEnter(object sender, EventArgs e)
    {
    }

    private void commentReplaceTextLeave(object sender, EventArgs e)
    {
    }

    private void commentReplaceTextMouseDown(object sender, MouseEventArgs e)
    {
    }

    private void OptionFormMouseDown(object sender, MouseEventArgs e)
    {
    }

    private void CommentReplaceTextClick(object sender, EventArgs e)
    {
    }

    private void CommentReplaceTextTextChanged(object sender, EventArgs e)
    {
    }

    private string getCommentReplaceText()
    {
    ...
    private void setCommentReplaceTextForm(string t)
    {
        var o = JsonConvert.DeserializeObject<List<string[]>>(t);
        try
        {
            for (var i = 0; i < o.Count; i++) commentReplaceList.Rows.Add(o[i][0], o[i][1].Replace("\n", "\\n"));
        }
        catch (Exception e)
        {
            util.debugWriteLine(e.Message + e.Source + e.StackTrace + e.TargetSite);
    ...
    private void commentReplaceEditBtnClick(object sender, EventArgs e)
    {
    ...
    private void ChPlusUpBtnClick(object sender, EventArgs e)
    {
    ...
    private void ChPlusDownBtnClick(object sender, EventArgs e)
    {
        var selectedIndex = chPlusQualityListBox.SelectedIndex;
    ...
    private void ChPlusHighRankBtnClick(object sender, EventArgs e)
    {
        var l = getItemsToRanksChPlus(chPlusQualityListBox.Items);
    ...
    private void ChPlusLowRankBtnClick(object sender, EventArgs e)
    {
        var l = getItemsToRanksChPlus(chPlusQualityListBox.Items);
    ...
    private List<string> getItemsToRanksChPlus(ListBox.ObjectCollection list)
    {
