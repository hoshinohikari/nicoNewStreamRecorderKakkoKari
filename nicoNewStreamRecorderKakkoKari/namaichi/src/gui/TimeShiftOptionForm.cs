...
public partial class TimeShiftOptionForm : Form
{
    ...
    private readonly bool isFmp4;
    private readonly string[] lastFileTime;
    private readonly int prepTime;
    private string lastFileName;
    private string[] lastFileTimeSelected;
    public TimeShiftConfig ret;
    ...
    private void okBtn_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        l.Add(new KeyValuePair<string, string>("tsEndSecond",
            (formEndH * 3600 + formEndM * 60 + formEndS).ToString()));
        l.Add(new KeyValuePair<string, string>("tsIsDeletePosTime",
            isDeletePosTimeChkBox.Checked.ToString().ToLower()));
        ...
        if (prepTime > 0)
        {
            l.Add(new KeyValuePair<string, string>("tsBaseOpenTimeStart",
                isOpenTimeBaseStartChkBox.Checked.ToString().ToLower()));
            l.Add(new KeyValuePair<string, string>("tsBaseOpenTimeEnd",
                isOpenTimeBaseEndChkBox.Checked.ToString().ToLower()));
        }

        l.Add(new KeyValuePair<string, string>("IsAfterStartTimeComment",
            isAfterStartTimeCommentChkBox.Checked.ToString().ToLower()));
        l.Add(new KeyValuePair<string, string>("IsBeforeEndTimeComment",
            isBeforeEndTimeCommentChkBox.Checked.ToString().ToLower()));
        config.set(l);
    ...
    private void isStartTimeRadioBtn_CheckedChanged(object sender, EventArgs e)
    {
        updateTimeShiftStartTimeChkBox();
    }

    private void isUrlListChkBox_CheckedChanged(object sender, EventArgs e)
    {
        updateUrlListChkBoxCheckedChanged();
    }

    private void updateUrlListChkBoxCheckedChanged()
    {
    ...
    private void isM3u8RadioBtn_CheckedChanged(object sender, EventArgs e)
    {
        updateIsM3u8RadioBtn_CheckedChanged();
    }

    private void updateIsM3u8RadioBtn_CheckedChanged()
    {
        updateListSecondText.Enabled = isM3u8RadioBtn.Checked;
    }

    private void isOpenListCommandChkBox_CheckedChanged(object sender, EventArgs e)
    {
        updateIsOpenListCommandChkBoxCheckedChanged();
    }

    private void updateIsOpenListCommandChkBoxCheckedChanged()
    {
        openListCommandText.Enabled = isOpenListCommandChkBox.Checked;
    }

    private void IsFromLastTimeRadioBtnCheckedChanged(object sender, EventArgs e)
    {
        updateIsFromLastTimeRadioBtn();
    }

    private void updateIsFromLastTimeRadioBtn()
    {
        isRenketuLastFile.Enabled = isFromLastTimeRadioBtn.Checked;
    }

    private void IsManualEndTimeRadioBtnCheckedChanged(object sender, EventArgs e)
    {
        updateIsManualEndTimeRadioBtn();
    }

    private void updateIsManualEndTimeRadioBtn()
    {
    ...
    private void setFormFromConfig()
    {
        ...
        hText.Text = (startSeconds / 3600).ToString();
        mText.Text = (startSeconds % 3600 / 60).ToString();
        sText.Text = (startSeconds % 60 / 1).ToString();
        var endSeconds = int.Parse(config.get("tsEndSecond"));
        endHText.Text = (endSeconds / 3600).ToString();
        endMText.Text = (endSeconds % 3600 / 60).ToString();
        endSText.Text = (endSeconds % 60 / 1).ToString();
        isDeletePosTimeChkBox.Checked = bool.Parse(config.get("tsIsDeletePosTime"));
    ...
    private void LastSettingBtnClick(object sender, EventArgs e)
    {
        setFormFromConfig();
    }

    private void OpenLastFileBtnClick(object sender, EventArgs e)
    {
    ...
    private void setLastFileTime(string[] t)
    {
        if (t != null)
    ...
    private List<int> getItemsToRanks(ListBox.ObjectCollection items)
    {
        ...
        for (var i = 0; i < items.Count; i++)
            foreach (var p in itemsDic)
                if (p.Value == items[i].ToString().Substring(3))
                    ret.Add(p.Key);
        return ret;
    }
...
//			ranks.AddRange(qualityRank.Split(','));
    ...
    private void HighRankBtnClick(object sender, EventArgs e)
    {
    ...
    private void LowRankBtnClick(object sender, EventArgs e)
    {
    ...
    private void openPanelBtnClick(object sender, EventArgs e)
    {
    ...
    private void OpenPanelBtnMouseDown(object sender, MouseEventArgs e)
    {
        openPanelBtn.Padding = new Padding(1, 1, 0, 0);
    }

    private void OpenPanelBtnLeave(object sender, EventArgs e)
    {
        openPanelBtn.Padding = new Padding(0);
    }

    private void OpenPanelBtnMouseLeave(object sender, EventArgs e)
    {
        openPanelBtn.Padding = new Padding(0);
    }

    private void OpenPanelBtnMouseUp(object sender, MouseEventArgs e)
    {
        openPanelBtn.Padding = new Padding(0);
    }
}