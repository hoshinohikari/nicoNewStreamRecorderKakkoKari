...
public class TimeShiftCommentGetter_chPlus : ITimeShiftCommentGetter
{
    ...
    private readonly Curl getMsgCurl = new();
    ...
    private readonly RedirectLogin rl;
    private readonly RecordingManager rm;
    private readonly string vpRes;
    private string commentConvertStr;
        ...
        IRecorderProcess rp, RedirectLogin rl)
    {
        ...
        this.rp = rp;
        isVposStartTime = tsConfig.isVposStartTime;
        this.ri = ri;
        this.rl = rl;
        ...
        */
        ...
        while (rm.rfu == rfu && isRetry)
            try
            {
                ...
                //test
                foreach (var b in l)
                    if (DateTime.Parse(b.sent_at) > testMostMaxSentAt)
                        testMostMaxSentAt = DateTime.Parse(b.sent_at);
    ...
    private List<chPlusMsgInfo> getMessages(string dt)
    {
        try
        {
    ...
    private string getUrl(string dt)
    {
