        ...
        else
        {
            using (var outFileStream = new FileStream(outName, FileMode.Append, FileAccess.Write))
            {
                ...
                foreach (var f in files)
                {
                    ...
                    {
                        util.debugWriteLine("arg concat write exception " + f + " " + e.Message + " " +
                                            e.StackTrace + " " + e.Source + " " + e.TargetSite);
                    }
                }
            }
...
//					var w = new FileStream(f, FileMode.Append, FileAccess.Write);
            ...
            catch (Exception e)
            {
                ...
                catch (Exception ee)
                {
                    ...
                    {
                        util.debugWriteLine("renketu after exception" + eee.Message + eee.StackTrace + eee.Source +
                                            eee.TargetSite);
                        rm.form.addLogText("出力先ファイルを作成できませんでした " + eee.Message + eee.Source + eee.StackTrace +
                                           eee.TargetSite);
                        return null;
                    }
                }
